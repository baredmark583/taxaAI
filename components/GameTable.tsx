...
const getPlayerPositions = (numPlayers: number) => {
    ...
    const radiusX = 65; // Make the oval wider for better horizontal spacing
    const radiusY = 55; // Make the oval shorter
    const centerX = 50;
    const centerY = 50;
    const angleOffset = -Math.PI / 2; // Start at top center
