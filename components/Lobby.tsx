  ...
  return (
    <div className="flex flex-col items-center p-2 sm:p-4">
      <div className="text-center my-4 animate-slide-up" style={{ animationDelay: '100ms' }}>
        <h1 className="text-4xl sm:text-5xl font-black tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-text-primary to-primary-accent drop-shadow-[0_0_15px_rgba(255,165,0,0.4)]">
          CRYPTO POKER CLUB
        </h1>
      ...
      <div className="w-full max-w-4xl bg-background-light rounded-xl shadow-2xl border border-brand-border animate-slide-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="p-2 sm:p-4 space-y-3 max-h-[calc(100vh-26rem)] overflow-y-auto">
