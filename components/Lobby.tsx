            ...
            {tablesToShow.length > 0 ? tablesToShow.map(table => (
                <div key={table.id} className="bg-surface/50 rounded-lg p-3 hover:bg-surface/80 transition-colors border border-transparent hover:border-primary-accent/50">
                    <div className="flex flex-wrap items-center justify-between gap-y-3">
                        ...
                        <div className="flex-grow pr-4 basis-full sm:basis-1/3">
                        ...
                        <div className="flex items-center gap-4 sm:gap-6 basis-1/2 sm:basis-1/3 justify-start sm:justify-center">
                        ...
                        {/* Block 3: Join Button */}
                        <div className="basis-1/2 sm:basis-1/3 sm:pl-4 flex justify-end">
                            <button
